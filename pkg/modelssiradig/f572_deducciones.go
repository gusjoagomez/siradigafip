...
type F572Deducciones struct {
	...
	Tipo              uint             `json:"tipo" gorm:"type:int4;column:tipo"`
	Tipodoc           uint             `json:"tipodoc" gorm:"type:int4;column:tipodoc"`
	Nrodoc            string           `json:"nrodoc" gorm:"type:varchar(11);column:nrodoc"`
...
func (e *F572Deducciones) TableName() string {
	return "siradig.f572_deducciones"
}
